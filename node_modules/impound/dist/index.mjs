...
function enrichAndReport(violation, moduleGraph, resolvedImports, entries, maxTraceDepth, cwd, warnedMessages) {
	...
	if (importerEntry) {
		...
		if (loc) snippet = {
			text: generateSnippet(importerEntry.code, loc.line, loc.column),
			line: loc.line,
			column: loc.column
		};
	}
			...
			for (const key of candidateKeys) {
				...
				if (pending) {
					...
					for (const violation of pending) {
						const warnedMessages = violation.options.warn !== "always" ? /* @__PURE__ */ new Set() : void 0;
