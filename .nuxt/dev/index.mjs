...
import { renderToString } from 'file://C:/Users/user1/Desktop/Nuxt/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://C:/Users/user1/Desktop/Nuxt/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/user1/Desktop/Nuxt/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://C:/Users/user1/Desktop/Nuxt/node_modules/scule/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://C:/Users/user1/Desktop/Nuxt/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://C:/Users/user1/Desktop/Nuxt/node_modules/devalue/index.js';
import { isVNode, isRef, toValue } from 'file://C:/Users/user1/Desktop/Nuxt/node_modules/vue/index.mjs';
import { createHooks } from 'file://C:/Users/user1/Desktop/Nuxt/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://C:/Users/user1/Desktop/Nuxt/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://C:/Users/user1/Desktop/Nuxt/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/user1/Desktop/Nuxt/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/user1/Desktop/Nuxt/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file://C:/Users/user1/Desktop/Nuxt/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/user1/Desktop/Nuxt/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://C:/Users/user1/Desktop/Nuxt/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://C:/Users/user1/Desktop/Nuxt/node_modules/youch-core/build/index.js';
import { Youch } from 'file://C:/Users/user1/Desktop/Nuxt/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://C:/Users/user1/Desktop/Nuxt/node_modules/source-map/source-map.js';
...
const serverAssets = [{"baseName":"server","dir":"C:/Users/user1/Desktop/Nuxt/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Users/user1/Desktop/Nuxt","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Users/user1/Desktop/Nuxt/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Users/user1/Desktop/Nuxt/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Users/user1/Desktop/Nuxt/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:/Users/user1/Desktop/Nuxt/.data/kv"}));
...
const _ymKPZvA0jbkB84ToSChkkviIko6XPUqq40AFfnUk9vw = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "C:/Users/user1/Desktop/Nuxt";
...
const _CbQIJPZ8VXqx9C6JuR4qJTapUsAkqXxA87TFDHLwJ4 = (nitroApp) => {
...
const plugins = [
  _ymKPZvA0jbkB84ToSChkkviIko6XPUqq40AFfnUk9vw,
...
const _UXVkiQ = eventHandler((event) => {
...
const getServerEntry = () => import('file://C:/Users/user1/Desktop/Nuxt/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
// @ts-expect-error file will be produced after app build
const getClientManifest = () => import('file://C:/Users/user1/Desktop/Nuxt/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
// -- SSR Renderer --
